...
/** Home Experiences split-panel background slideshow — matches zion-creativeartisans.com gallery */
export const homeExperiencesSlideshow = [
  ...
  `${base}/pexels-emrecan-2110945-scaled-r0puczyp0wiiy2upc2fwrbhnqrfgpfmzdbext3ue8s.jpg`,
  `${base}/pexels-freestockpro-1007836.jpg`,
  `${base}/pexels-gusrama12-5777405-1.jpg`,
  `${base}/pexels-kadiravsarr-24877149.jpg`,
  `${base}/pexels-koprivakart-3716087-scaled.jpg`,
  `${base}/pexels-loic-manegarium-3724836.jpg`,
  `${base}/pexels-ollivves-1223648-scaled.jpg`,
  `${base}/pexels-oripolito-1550913.jpg`,
